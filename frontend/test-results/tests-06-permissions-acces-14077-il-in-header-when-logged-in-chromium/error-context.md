...
- Name: tests/06-permissions-access-control.spec.ts >> Permissions and Access Control >> should display user name/email in header when logged in
- Location: e2e/tests/06-permissions-access-control.spec.ts:171:3
