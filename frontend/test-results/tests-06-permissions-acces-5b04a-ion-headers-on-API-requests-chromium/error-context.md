...
- Name: tests/06-permissions-access-control.spec.ts >> Permissions and Access Control >> should validate authorization headers on API requests
- Location: e2e/tests/06-permissions-access-control.spec.ts:296:3
