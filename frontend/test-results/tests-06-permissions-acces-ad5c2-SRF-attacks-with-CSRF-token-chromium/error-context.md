...
- Name: tests/06-permissions-access-control.spec.ts >> Permissions and Access Control >> should prevent CSRF attacks with CSRF token
- Location: e2e/tests/06-permissions-access-control.spec.ts:131:3
