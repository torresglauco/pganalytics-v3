...
- Name: tests/06-permissions-access-control.spec.ts >> Permissions and Access Control >> should allow access after successful login
- Location: e2e/tests/06-permissions-access-control.spec.ts:34:3
