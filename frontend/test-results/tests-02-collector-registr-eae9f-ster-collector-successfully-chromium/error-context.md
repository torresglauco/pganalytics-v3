...
- Name: tests/02-collector-registration.spec.ts >> Collector Registration >> should register collector successfully
- Location: e2e/tests/02-collector-registration.spec.ts:83:3
