...
- Name: tests/06-permissions-access-control.spec.ts >> Permissions and Access Control >> should validate session on API calls
- Location: e2e/tests/06-permissions-access-control.spec.ts:72:3
