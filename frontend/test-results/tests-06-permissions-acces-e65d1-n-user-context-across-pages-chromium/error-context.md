...
- Name: tests/06-permissions-access-control.spec.ts >> Permissions and Access Control >> should maintain user context across pages
- Location: e2e/tests/06-permissions-access-control.spec.ts:151:3
