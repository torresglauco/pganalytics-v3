...
- Name: tests/02-collector-registration.spec.ts >> Collector Registration >> should handle registration errors
- Location: e2e/tests/02-collector-registration.spec.ts:133:3
