...
- Name: tests/02-collector-registration.spec.ts >> Collector Registration >> should display collectors page
- Location: e2e/tests/02-collector-registration.spec.ts:19:3
