...
- Name: tests/02-collector-registration.spec.ts >> Collector Registration >> should validate required fields
- Location: e2e/tests/02-collector-registration.spec.ts:44:3
