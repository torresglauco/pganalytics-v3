...
- Name: tests/02-collector-registration.spec.ts >> Collector Registration >> should display registered collectors
- Location: e2e/tests/02-collector-registration.spec.ts:121:3
