...
- Name: tests/02-collector-registration.spec.ts >> Collector Registration >> should test database connection
- Location: e2e/tests/02-collector-registration.spec.ts:58:3
