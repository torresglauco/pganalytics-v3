...
- Name: tests/06-permissions-access-control.spec.ts >> Permissions and Access Control >> should protect against XSS in user input
- Location: e2e/tests/06-permissions-access-control.spec.ts:238:3
